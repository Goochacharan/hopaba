...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-start rounded-none bg-transparent",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-primary data-[state=active]:text-primary-foreground", // Add active state styling
      "data-[state=active]:shadow-sm", // Add shadow for active state
      className
    )}
    {...props}
  />
